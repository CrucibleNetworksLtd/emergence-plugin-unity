...
namespace EmergenceSDK
{
    public partial class Services
    {
        ...
        private IEnumerator CoroutineHandshake(HandshakeSuccess success, GenericError error)
        {
            ...
            string url = LocalEmergenceServer.Instance.Environment().APIBase + "handshake" + "?nodeUrl=" + EmergenceSingleton.Instance.Configuration.Chain.DefaultNodeURL;
        ...
        private IEnumerator CoroutineGetBalance(string address, BalanceSuccess success, GenericError error)
        {
            ...
            string url = LocalEmergenceServer.Instance.Environment().APIBase + "getbalance" + "?nodeUrl=" + EmergenceSingleton.Instance.Configuration.Chain.DefaultNodeURL + "&address=" + address;
