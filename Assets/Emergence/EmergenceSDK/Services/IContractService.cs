...
namespace EmergenceSDK.Services
{
    ...
    public interface IContractService : IEmergenceService
    {
        ...
        /// <summary>
        /// Obsolete, see <see cref="WriteMethod{T}(EmergenceSDK.Internal.Utils.ContractInfo,string,T,EmergenceSDK.Types.Delegates.WriteMethodSuccess,EmergenceSDK.Types.Delegates.ErrorCallback)"/>
        /// </summary>
        ...
        /// <summary>
        /// Obsolete, see <see cref="WriteMethodAsync{T}(EmergenceSDK.Internal.Utils.ContractInfo,string,T)"/>
        /// </summary>
        /// <returns>A <see cref="WriteContractResponse"/> wrapped within a <see cref="ServiceResponse{T}"/> object</returns>
