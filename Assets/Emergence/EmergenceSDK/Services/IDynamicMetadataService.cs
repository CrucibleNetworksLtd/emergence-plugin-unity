...
namespace EmergenceSDK.Services
{
    ...
    public interface IDynamicMetadataService : IEmergenceService
    {
        ...
        /// <summary>
        /// Obsolete, see <see cref="WriteDynamicMetadata(string,string,string,string,string,EmergenceSDK.Types.Delegates.SuccessWriteDynamicMetadata,EmergenceSDK.Types.Delegates.ErrorCallback)"/>
        /// </summary>
        ...
        /// <summary>
        /// Obsolete, see <see cref="WriteNewDynamicMetadata(string,string,string,string,string,EmergenceSDK.Types.Delegates.SuccessWriteDynamicMetadata,EmergenceSDK.Types.Delegates.ErrorCallback)"/>
        /// </summary>
